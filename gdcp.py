...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('file_id', help='The file id or drive link for the file you\'re going to copy')

    arg_parser.add_argument('-t', '--new_title', help='the title for the new file')
